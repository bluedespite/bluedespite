...
<head>
    ...
    <title>Roraima Bussiness Integrator</title>
...
<body>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="#">Contrato 001</a>
                        </li>
                        <li>
                            <a href="#">Contrato 002</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Bahias</a>
    ...
    <script>
    	var mymap = L.map('mapid').setView([-9.189967, -75.015152], 13);
