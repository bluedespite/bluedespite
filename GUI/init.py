...
class Window:
    def __init__(self):
        ...
        self.ventana.etiq6=Label(self.ventana, text="Densidad Prod(Kgr/cm2): $"+columnas[6])
        ...
        #Unidad de la Medida
        self.ventana.etiq9=Label(self.ventana, text="Unidad de Medida: $"+columnas[9])
        ...
        self.ventana.etiq18=Label(self.ventana, text="Tabla de Linealizacion (X:Y) $"+columnas[18])
