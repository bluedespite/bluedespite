                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Estacion" name="estacion" required >
                        </div>
                      </div>
                      <div class="col-md-4 pl-1">
                        <div class="form-group">
                          <label>Tanque</label>
                          <input type="text" class="form-control" placeholder="Tanque" name="tanque" required >
                        </div>
                      </div>
                    </div>
                    <div class="row">
